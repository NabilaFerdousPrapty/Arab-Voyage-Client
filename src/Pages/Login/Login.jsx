    ...
    <div className="flex justify-center items-center mt-10">
      <div className="w-full max-w-md p-8 space-y-3 rounded-xl  ">
        ...
        <form onSubmit={handleSubmit(onSubmit)} action="" className="space-y-6">
          ...
          <button
            type="submit"
            className="rounded-xl block w-full p-3 text-center rounded-sm text-white bg-gray-800 hover:bg-gray-900"
          >
            Sign in
          </button>
        </form>
        ...
        <p className="text-xs text-center sm:px-6 text-gray-600">
          ...
          <Link to="/signup" className="underline text-slate-600">
            Sign up
          </Link>
        </p>
      </div>
